classdef AbstractHeavyGraph < handle
    % HeavyLocalGroups are LGs that can contain data > 2GB. To store this
    ...
    % Default methods work if a property named 'NNids' is the only heavy data.
    %
    % 
    %
    %<PRE>
