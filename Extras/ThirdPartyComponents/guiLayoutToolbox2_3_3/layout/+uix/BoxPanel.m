classdef BoxPanel < uix.Panel & uix.mixin.Panel
    ...
    properties
        ...
        PinTooltipString = 'Pin this window to be always on top'
        UnpinTooltipString = 'Unpin this window from the top'
    ...
    methods
        ...
        function obj = BoxPanel( varargin )
            ...
            pinButton = uix.Text( ...
                'ForegroundColor', foregroundColor, ...
                'BackgroundColor', backgroundColor, ...
                'FontWeight', 'bold', 'String', ['' char( hex2dec('25E2') ) '      '], ...
                'TooltipString', obj.PinTooltipString, 'Enable', 'on' );
...
%             end
    ...
    methods
        ...
        function set.TitleColor( obj, value )
            ...
            obj.PinButton.BackgroundColor = value;
        ...
        function set.DockFcn( obj, value )
            ...
            %obj.DockButton.BtnDownFcn = value;
        ...
        function value = get.PinFcn( obj )
            
            value = obj.PinButton.Callback;
            
        end % get.PinFcn
        
        function set.PinFcn( obj, value )
            
            % Set
            obj.PinButton.Callback = value;
        ...
        function value = get.Pinned( obj )
            
            value = obj.Pinned_;
            
        end % get.Docked
        
        function set.Pinned( obj, value )
        ...
        function set.PinTooltipString( obj, value )
            % Check
            assert( ischar( value ), ...
                'uix:InvalidPropertyValue', ...
            ...
            % Set
            obj.PinTooltipString = value;
            
            % Mark as dirty
            obj.redrawButtons()
        end
        function set.UnpinTooltipString( obj, value )
            % Check
            assert( ischar( value ), ...
                'uix:InvalidPropertyValue', ...
                'Property ''MaximizeTooltipString'' must be a string.' )
    ...
    methods( Access = private )
        ...
        function onFontSizeChanged( obj, ~, ~ )
            ...
            obj.PinButton.FontSize = fontSize;
        ...
        function onFontUnitsChanged( obj, ~, ~ )
            ...
            obj.PinButton.FontUnits = fontUnits;
        ...
        function onForegroundColorChanged( obj, ~, ~ )
            ...
            obj.PinButton.ForegroundColor = foregroundColor;
    ...
    methods( Access = protected )
        ...
        function redraw( obj )
            ...
            %% This function gets called when parent windows are resized
            % but not when parent HBox_flex or VBox_flex are changed
            %dspace.modules.UiUtils.fprintf_orange('BoxPanel Redraw: %s\n', obj.Title);
            ...
            if ~isempty(obj.redraw_callback)
                obj.redraw_callback(obj);
            end
    ...
    methods( Access = private )
        ...
        function redrawButtons( obj )
            ...
            pin = ~isempty( obj.PinFcn );
            if pin
                pinButton.Parent = box;
                box.Widths(end) = pinButton.Extent(3);
            end
            ...
            if obj.Docked_
                pinButton.Visible = 'off';
                
            else
                if obj.Pinned_
                    pinButton.String = [char( hex2dec('25B0') ) '  '];
                    %pinButton.String = char( hex2dec('21DE') );
                    pinButton.TooltipString = obj.PinTooltipString;
                else
                    pinButton.String = [char( hex2dec('25E2') ) '  '];
                    %pinButton.String = char( hex2dec('21DF') );
                    pinButton.TooltipString = obj.UnpinTooltipString;
                end
                pinButton.Visible = 'on';
            end
