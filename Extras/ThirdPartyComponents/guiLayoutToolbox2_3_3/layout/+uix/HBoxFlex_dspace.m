classdef HBoxFlex_dspace < uix.HBox & uix.mixin.Flex
    ...
    methods
        ...
        function obj = HBoxFlex_dspace( varargin )
...
%                 end
                ...
                %dspace.modules.UiUtils.fprintf_orange('HBoxFlex slider moved.\n');
            else
                return
            end
...
%                 end
    ...
    methods( Access = protected )
        ...
        function redraw( obj )
            ...
            %dspace.modules.UiUtils.fprintf_orange('HBoxFlex redraw.\n');
