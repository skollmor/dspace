classdef VBoxFlex_dspace < uix.VBox & uix.mixin.Flex
    ...
    methods
        ...
        function obj = VBoxFlex_dspace( varargin )
...
%                 end
                ...
                %dspace.modules.UiUtils.fprintf_orange('VBoxFlex slider moved.\n');
            else
                return
            end
...
%                 end
    ...
    methods( Access = protected )
        ...
        function redraw( obj )
            ...
            redraw@uix.VBox( obj )
            %dspace.modules.UiUtils.fprintf_orange('VBoxFlex redraw.\n');
