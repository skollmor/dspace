classdef Container < handle
    ...
    properties ( Access = public ) % SK: added new property <Dormant>
        Dormant = false;
    end
        ...
        function set.Dirty( obj, value )
            ...
            if value
                if obj.isDrawable()...  % drawable
                        %&& ~obj.Dormant %SK: added condition
                    %fprintf('dirty %i\n', randi(100));
    ...
    methods( Access = private, Sealed )
        ...
        function onFigureChanged( obj, ~, eventData )
            ...
            if obj.Dormant && ~isempty(eventData.NewFigure) && strcmp(eventData.NewFigure.Visible, 'on')
                obj.Dormant = false;
            end
    ...
    methods( Access = protected )
        ...
        function tf = isDrawable( obj )
            ...
            tf = ~isempty( obj.FigureObserver.Figure )...
                && ~obj.Dormant; % SK: added this condition
            %strcmp(obj.FigureObserver.Figure.Visible, 'on'); % SK: added this condition
